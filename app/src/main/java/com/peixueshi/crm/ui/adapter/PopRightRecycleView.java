...
public class PopRightRecycleView extends RecyclerView.Adapter<PopRightRecycleView.ViewHolder> {
    ...
    public PopRightRecycleView(Context activity, List<Map<String,String>> infos) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
          ...
          Map<String,String> info = mapInfos.get(position);
            ...
            holder.tv_price.setText(info.get("c_price"));
        if(mListener!=null){
