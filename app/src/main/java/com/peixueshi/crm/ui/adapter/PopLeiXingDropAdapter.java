...
public class PopLeiXingDropAdapter extends RecyclerView.Adapter<PopLeiXingDropAdapter.ViewHolder> {

    private List<String> mapInfos;

    private Context activity;

    public void setData(List<String> listPidInfo) {
    ...
    public PopLeiXingDropAdapter(Context activity, List<String> infos) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        String info = mapInfos.get(position);
        holder.tv_xiangmu.setText(info);
        if (mListener != null) {
