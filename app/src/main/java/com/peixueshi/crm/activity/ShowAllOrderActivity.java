...
public class ShowAllOrderActivity extends BaseActivity{
        ...
        tv_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(TextUtils.isEmpty(et_pass_text.getText().toString()) ||  TextUtils.isEmpty(et_pass_new_text.getText().toString()) || TextUtils.isEmpty(et_pass_new_sure_text.getText().toString())){
                    PromptManager.showMyToast("密码不能为空", ShowAllOrderActivity.this);
                    return;
                }
                if(!et_pass_new_text.getText().toString().equals(et_pass_new_sure_text.getText().toString())){
                    PromptManager.showMyToast("两次密码不一致", ShowAllOrderActivity.this);
                    return;
                }
                PromptManager.hideKeyboard(ShowAllOrderActivity.this);
    ...
    private void modifyPass(String oldpass, String newpass) {
            try {
                    ...
                    OkHttpUtils.get(ShowAllOrderActivity.this, reqUrl, new OkhttpCallback()
                    {
                        @Override
    ...
    private void getOrderInfo(JSONObject job) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        PromptManager.showMyToast("密码修改成功", ShowAllOrderActivity.this);
                        finish();
                    }
                });
